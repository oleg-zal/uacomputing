...
use EasyWPSMTP\Vendor\SendinBlue\Client\ApiException;
use EasyWPSMTP\Vendor\SendinBlue\Client\Model\CreateSmtpEmail;
use EasyWPSMTP\Vendor\SendinBlue\Client\Model\SendSmtpEmail;
use EasyWPSMTP\WP;
...
class Mailer extends MailerAbstract {
	...
	public function send() {
		...
		try {
			...
			DebugEvents::add_debug(
				esc_html__( 'An email request was sent to the Brevo API.', 'easy-wp-smtp' )
			);
	...
	protected function process_response( $response ) {
		...
		if (
			is_a( $response, 'EasyWPSMTP\Vendor\SendinBlue\Client\Model\CreateSmtpEmail' ) &&
