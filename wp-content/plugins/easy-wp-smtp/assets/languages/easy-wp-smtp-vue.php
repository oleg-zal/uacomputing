...
$generated_i18n_strings = array(
	...
	__( 'Yikes! PHP Update Required', 'easy-wp-smtp' ),

	// Reference: src/plugins/compatibility-plugin.js:16
	/* Translators: Current PHP version and recommended PHP version. */
	__( 'Easy WP SMTP has detected that your site is running an outdated, insecure version of PHP (%1$s), which could be putting your site at risk for being hacked. Updating to the recommended version (PHP %2$s) only takes a few minutes and will make your website significantly faster and more secure.', 'easy-wp-smtp' ),
	...
	// Reference: src/plugins/compatibility-plugin.js:30
	...
	__( 'It looks like we can\'t load oAuth connected data.', 'easy-wp-smtp' ),
	...
	__( '%1$sFollow this link%2$s to get an API Key for Sendinblue.', 'easy-wp-smtp' ),
	...
	__( 'Get Started with Sendinblue', 'easy-wp-smtp' ),

	// Reference: src/modules/setup-wizard/components/steps/configure-mailer/Sendinblue.vue:28
	__( 'Read how to set up Sendinblue', 'easy-wp-smtp' ),
	...
	__( 'We believe in full transparency. The Sendinblue links above are tracking links as part of our partnership with Sendinblue. We can recommend just about any SMTP service, but we only recommend products that we believe will add value to our users.', 'easy-wp-smtp' ),
	...
	__( 'We tried sending a test email, but we’re able to do so. For more details about the issue we’ve found, as well as steps for resolving it, please begin troubleshooting.', 'easy-wp-smtp' ),
	...
	__( 'Help Improve Easy WP SMTP + Smart Recommendations', 'easy-wp-smtp' ),
	...
	__( 'Your email is needed, so you can receive recommendations.', 'easy-wp-smtp' ),
	...
	__( 'By allowing us to track usage data we can better help you because we know with which WordPress configurations, themes and plugins we should test.', 'easy-wp-smtp' ),
	...
	__( 'Private API Key', 'easy-wp-smtp' ),
	...
	__( '%1$sFollow this link%2$s to get a Private API Key from Mailgun.', 'easy-wp-smtp' ),
	...
	// Reference: src/modules/setup-wizard/components/steps/WizardStepChooseMailer.vue:110
	__( 'Mailer', 'easy-wp-smtp' ),

	// Reference: src/modules/setup-wizard/components/steps/WizardStepChooseMailer.vue:120
	__( 'I Understand, Continue', 'easy-wp-smtp' ),

	// Reference: src/modules/setup-wizard/components/steps/WizardStepChooseMailer.vue:121
	...
	// Reference: src/modules/setup-wizard/components/steps/WizardStepChooseMailer.vue:28
	...
	__( 'You\'re currently using Easy WP SMTP Lite - no license needed. Enjoy!', 'easy-wp-smtp' ),

	// Reference: src/modules/setup-wizard/components/steps/WizardStepLicense.vue:16
	__( 'Continue', 'easy-wp-smtp' ),

	// Reference: src/modules/setup-wizard/components/steps/WizardStepLicense.vue:161
	...
	// Reference: src/modules/setup-wizard/components/steps/WizardStepLicense.vue:177
	__( 'Purchase Now', 'easy-wp-smtp' ),

	// Reference: src/modules/setup-wizard/components/steps/WizardStepLicense.vue:178
	...
	__( 'To unlock selected features, %1$sUpgrade to Pro%2$s and enter your license key below.', 'easy-wp-smtp' ),
	...
	__( 'Already purchased? Enter your license key below to connect with %1$sEasy WP SMTP Pro%2$s!', 'easy-wp-smtp' ),
	...
	__( 'View your emails’ delivery status, open&link click tracking, and deliverability charts.', 'easy-wp-smtp' ),
	...
	// Reference: src/modules/setup-wizard/components/steps/WizardStepLicense.vue:70
	...
	// Reference: src/modules/setup-wizard/components/steps/WizardStepLicense.vue:99
	...
	// Reference: src/modules/setup-wizard/components/steps/WizardStepPluginFeatures.vue:135
	__( 'The following plugin will be installed for free: WPForms', 'easy-wp-smtp' ),
	...
	__( 'Create beautiful contact forms with just a few clicks.', 'easy-wp-smtp' ),
	...
	/* Translators: name of the oAuth provider (Microsoft, ...). */
	...
	// Reference: src/modules/settings/components/input/SettingsOAuthConnection.vue:95
	__( 'There was an error while processing the authentication request. The state key is invalid. Please try again.', 'easy-wp-smtp' ),

	// Reference: src/modules/settings/components/input/SettingsOAuthConnection.vue:98
