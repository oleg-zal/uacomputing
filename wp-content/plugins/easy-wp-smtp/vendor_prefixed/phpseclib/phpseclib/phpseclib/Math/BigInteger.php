 ...
 */
namespace EasyWPSMTP\Vendor\phpseclib3\Math;

use EasyWPSMTP\Vendor\phpseclib3\Exception\BadConfigurationException;
use EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    {
        self::$engines = [];
        $fqmain = 'EasyWPSMTP\\Vendor\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
        ...
        if (!$fqmain::isValidEngine()) {
            throw new \EasyWPSMTP\Vendor\phpseclib3\Exception\BadConfigurationException("{$main} is not setup correctly on this system");
        }
        ...
        if (!$found) {
            throw new \EasyWPSMTP\Vendor\phpseclib3\Exception\BadConfigurationException("No valid modular exponentiation engine found for {$main}");
        }
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function subtract(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function modInverse(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger[]
     */
    public function extendedGCD(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $e, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $e, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @see self::equals()
     */
    public function compare(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return bool
     */
    public function equals(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $min, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $min, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $min, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x) use($func) {
