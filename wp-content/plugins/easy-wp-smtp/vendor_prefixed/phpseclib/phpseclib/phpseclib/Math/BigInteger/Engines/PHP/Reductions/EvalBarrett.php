 ...
 */
namespace EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;
use EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
     ...
     * @return callable
     */
    protected static function generateCustomReduction(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $m, $class)
    {
