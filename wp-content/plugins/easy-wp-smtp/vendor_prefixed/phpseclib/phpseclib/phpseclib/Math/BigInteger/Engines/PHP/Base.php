 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class Base extends \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP
{
    /**
     * Cache constants
     *
     ...
     * @return PHP
     */
    protected static function powModHelper(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $x, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $e, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = [1];
