 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class Base extends \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath
{
    /**
     * Cache constants
     *
     ...
     * @return BCMath
     */
    protected static function powModHelper(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $e, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = '1';
