 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
final class PrivateKey extends \EasyWPSMTP\Vendor\phpseclib3\Crypt\RSA implements \EasyWPSMTP\Vendor\phpseclib3\Crypt\Common\PrivateKey
{
     ...
     */
    private function rsadp(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $c)
    {
     ...
     * @return bool|\phpseclib3\Math\BigInteger
     */
    private function rsasp1(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $m)
    {
     ...
     */
    protected function exponentiate(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
        switch (\true) {
        ...
        if (!static::$enableBlinding) {
            ...
            $r = \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger::randomRange(self::$one, $smallest->subtract(self::$one));
     ...
     * @return \phpseclib3\Math\BigInteger
     */
    private function blind(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $r, $i)
    {
    ...
    private function emsa_pss_encode($m, $emBits)
    {
        ...
        $salt = \EasyWPSMTP\Vendor\phpseclib3\Crypt\Random::string($sLen);
    ...
    public function getPublicKey()
    {
        ...
        return \EasyWPSMTP\Vendor\phpseclib3\Crypt\RSA::loadFormat('PKCS8', $key)->withHash($this->hash->getHash())->withMGFHash($this->mgfHash->getHash())->withSaltLength($this->sLen)->withLabel($this->label)->withPadding($this->signaturePadding | $this->encryptionPadding);
    }
    /**
