...
use EasyWPSMTP\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards;
...
class Ed448 extends \EasyWPSMTP\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards
{
    ...
    {
        // 2^448 - 2^224 - 1
        $this->setModulo(new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE' . 'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', 16));
        $this->setCoefficients(
            new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger(1),
            // -39081
            new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE' . 'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF6756', 16)
        );
        $this->setBasePoint(new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger('4F1970C66BED0DED221D15A622BF36DA9E146570470F1767EA6DE324' . 'A3D3A46412AE1AF72AB66511433B80E18B00938E2626A82BC70CC05E', 16), new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger('693F46716EB6BC248876203756C9C7624BEA73736CA3984087789C1E' . '05A0C2D73AD3FF1CE67C39C4FDBD132C4ED7C8AD9808795BF230FA14', 16));
        $this->setOrder(new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger('3FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF' . '7CCA23E9C44EDB49AED63690216CC2728DC58F552378C292AB5844F3', 16));
    }
    /**
     * Recover X from Y
     *
     ...
     * @return object[]
     */
    public function recoverX(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $y, $sign)
    {
        ...
        $exp = $this->getModulo()->add(new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger(1));
    ...
    public function extractSecret($str)
    {
        ...
        $hash = new \EasyWPSMTP\Vendor\phpseclib3\Crypt\Hash('shake256-912');
        $h = $hash->hash($str);
        $h = \substr($h, 0, 57);
        ...
        //     secret scalar s.
        $dA = new \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger($h, 256);
    ...
    {
        return $this->extractSecret(\EasyWPSMTP\Vendor\phpseclib3\Crypt\Random::string(57))['dA'];
    }
    /**
