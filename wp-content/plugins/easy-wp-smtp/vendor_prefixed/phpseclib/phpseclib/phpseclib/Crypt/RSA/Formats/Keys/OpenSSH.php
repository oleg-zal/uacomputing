...
abstract class OpenSSH extends \EasyWPSMTP\Vendor\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (isset($parsed['paddedKey'])) {
            ...
            $primes = $coefficients = [];
            list($modulus, $publicExponent, $privateExponent, $coefficients[2], $primes[1], $primes[2], $comment, ) = \EasyWPSMTP\Vendor\phpseclib3\Common\Functions\Strings::unpackSSH2('i6s', $parsed['paddedKey']);
        ...
        list($publicExponent, $modulus) = \EasyWPSMTP\Vendor\phpseclib3\Common\Functions\Strings::unpackSSH2('ii', $parsed['publicKey']);
    ...
    {
        $RSAPublicKey = \EasyWPSMTP\Vendor\phpseclib3\Common\Functions\Strings::packSSH2('sii', 'ssh-rsa', $e, $n);
    ...
    public static function savePrivateKey(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $e, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $privateKey = \EasyWPSMTP\Vendor\phpseclib3\Common\Functions\Strings::packSSH2('si6', 'ssh-rsa', $n, $e, $d, $coefficients[2], $primes[1], $primes[2]);
