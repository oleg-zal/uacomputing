...
abstract class PKCS1 extends \EasyWPSMTP\Vendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS1
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $key = \EasyWPSMTP\Vendor\phpseclib3\File\ASN1::asn1map($decoded[0], \EasyWPSMTP\Vendor\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
        if (\is_array($key)) {
        ...
        $key = \EasyWPSMTP\Vendor\phpseclib3\File\ASN1::asn1map($decoded[0], \EasyWPSMTP\Vendor\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
        if (!\is_array($key)) {
    ...
    public static function savePrivateKey(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $e, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $key = \EasyWPSMTP\Vendor\phpseclib3\File\ASN1::encodeDER($key, \EasyWPSMTP\Vendor\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
    ...
    public static function savePublicKey(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $n, \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $e)
    {
        ...
        $key = \EasyWPSMTP\Vendor\phpseclib3\File\ASN1::encodeDER($key, \EasyWPSMTP\Vendor\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
