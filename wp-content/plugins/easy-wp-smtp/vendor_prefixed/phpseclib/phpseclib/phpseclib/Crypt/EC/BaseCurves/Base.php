...
abstract class Base
{
     ...
     * @return object
     */
    public function convertInteger(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
    ...
    public function createRandomMultiplier()
    {
        ...
        return \EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger::randomRange($one, $this->order->subtract($one));
    }
    /**
     ...
     * Sets the Order
     */
    public function setOrder(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $order)
    {
        $this->order = $order;
    }
    /**
