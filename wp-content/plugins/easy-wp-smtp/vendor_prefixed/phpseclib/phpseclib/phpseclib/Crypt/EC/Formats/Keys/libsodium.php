...
abstract class libsodium
{
     ...
     * @return string
     */
    public static function savePublicKey(\EasyWPSMTP\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey)
    {
     ...
     * @return string
     */
    public static function savePrivateKey(\EasyWPSMTP\Vendor\phpseclib3\Math\BigInteger $privateKey, \EasyWPSMTP\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey, $secret = null, $password = '')
    {
        if (!isset($secret)) {
        ...
        if (!empty($password) && \is_string($password)) {
            throw new \EasyWPSMTP\Vendor\phpseclib3\Exception\UnsupportedFormatException('libsodium private keys do not support encryption');
        }
