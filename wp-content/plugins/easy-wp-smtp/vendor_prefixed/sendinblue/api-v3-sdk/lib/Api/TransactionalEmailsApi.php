 ...
 */
namespace EasyWPSMTP\Vendor\SendinBlue\Client\Api;

use EasyWPSMTP\Vendor\GuzzleHttp\Client;
use EasyWPSMTP\Vendor\GuzzleHttp\ClientInterface;
use EasyWPSMTP\Vendor\GuzzleHttp\Exception\RequestException;
use EasyWPSMTP\Vendor\GuzzleHttp\Psr7\MultipartStream;
use EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Request;
use EasyWPSMTP\Vendor\GuzzleHttp\RequestOptions;
use EasyWPSMTP\Vendor\SendinBlue\Client\ApiException;
use EasyWPSMTP\Vendor\SendinBlue\Client\Configuration;
use EasyWPSMTP\Vendor\SendinBlue\Client\HeaderSelector;
...
class TransactionalEmailsApi
{
     ...
     */
    public function __construct(\EasyWPSMTP\Vendor\GuzzleHttp\ClientInterface $client = null, \EasyWPSMTP\Vendor\SendinBlue\Client\Configuration $config = null, \EasyWPSMTP\Vendor\SendinBlue\Client\HeaderSelector $selector = null)
    {
        $this->client = $client ?: new \EasyWPSMTP\Vendor\GuzzleHttp\Client();
        $this->config = $config ?: new \EasyWPSMTP\Vendor\SendinBlue\Client\Configuration();
        $this->headerSelector = $selector ?: new \EasyWPSMTP\Vendor\SendinBlue\Client\HeaderSelector();
    }
    /**
    ...
    public function blockNewDomainWithHttpInfo($blockDomain)
    {
        ...
        try {
            ...
            } catch (\EasyWPSMTP\Vendor\GuzzleHttp\Exception\RequestException $e) {
                throw new \EasyWPSMTP\Vendor\SendinBlue\Client\ApiException("[{$e->getCode()}] {$e->getMessage()}", $e->getCode(), $e->getResponse() ? $e->getResponse()->getHeaders() : null, $e->getResponse() ? $e->getResponse()->getBody()->getContents() : null);
            }
            $statusCode = $response->getStatusCode();
            if ($statusCode < 200 || $statusCode > 299) {
                throw new \EasyWPSMTP\Vendor\SendinBlue\Client\ApiException(\sprintf('[%d] Error connecting to the API (%s)', $statusCode, $request->getUri()), $statusCode, $response->getHeaders(), $response->getBody());
            }
            return [null, $statusCode, $response->getHeaders()];
        } catch (\EasyWPSMTP\Vendor\SendinBlue\Client\ApiException $e) {
            switch ($e->getCode()) {
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    public function blockNewDomainAsyncWithHttpInfo($blockDomain)
    {
        ...
        return $this->client->sendAsync($request, $this->createHttpClientOption())->then(function ($response) use($returnType) {
            ...
            $statusCode = $response->getStatusCode();
            throw new \EasyWPSMTP\Vendor\SendinBlue\Client\ApiException(\sprintf('[%d] Error connecting to the API (%s)', $statusCode, $exception->getRequest()->getUri()), $statusCode, $response->getHeaders(), $response->getBody());
        });
    }
    /**
    ...
    protected function blockNewDomainRequest($blockDomain)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($headers['Content-Type'] === 'application/json') {
                ...
                if ($httpBody instanceof \stdClass) {
                    $httpBody = \EasyWPSMTP\Vendor\GuzzleHttp\json_encode($httpBody);
                }
                // array has no __toString(), so we should encode it manually
                if (\is_array($httpBody)) {
                    $httpBody = \EasyWPSMTP\Vendor\GuzzleHttp\json_encode(\EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::sanitizeForSerialization($httpBody));
                }
            }
            ...
            if ($multipart) {
                ...
                // for HTTP post (form)
                $httpBody = new \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\MultipartStream($multipartContents);
            } elseif ($headers['Content-Type'] === 'application/json') {
                $httpBody = \EasyWPSMTP\Vendor\GuzzleHttp\json_encode($formParams);
            } else {
                // for HTTP post (form)
                $httpBody = \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Query::build($formParams);
            }
        }
        ...
        $query = \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Query::build($queryParams);
        return new \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Request('POST', $this->config->getHost() . $resourcePath . ($query ? "?{$query}" : ''), $headers, $httpBody);
    }
    /**
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateModel';
        ...
        try {
            ...
            return [\EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($content, $returnType, []), $response->getStatusCode(), $response->getHeaders()];
        } catch (\EasyWPSMTP\Vendor\SendinBlue\Client\ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function deleteBlockedDomainRequest($domain)
    {
        ...
        // path params
        if ($domain !== null) {
            $resourcePath = \str_replace('{' . 'domain' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($domain), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
        ...
        $headers = \array_merge($defaultHeaders, $headerParams, $headers);
        $query = \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Query::build($queryParams);
        return new \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Request('DELETE', $this->config->getHost() . $resourcePath . ($query ? "?{$query}" : ''), $headers, $httpBody);
    }
    /**
    ...
    protected function deleteSmtpTemplateRequest($templateId)
    {
        ...
        // path params
        if ($templateId !== null) {
            $resourcePath = \str_replace('{' . 'templateId' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($templateId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetAggregatedReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetAggregatedReport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function getAggregatedSmtpReportRequest($startDate = null, $endDate = null, $days = null, $tag = null)
    {
        ...
        // query params
        if ($startDate !== null) {
            $queryParams['startDate'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($startDate);
        }
        // query params
        if ($endDate !== null) {
            $queryParams['endDate'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($endDate);
        }
        // query params
        if ($days !== null) {
            $queryParams['days'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($days);
        }
        // query params
        if ($tag !== null) {
            $queryParams['tag'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($tag);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
        ...
        $headers = \array_merge($defaultHeaders, $headerParams, $headers);
        $query = \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Query::build($queryParams);
        return new \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Request('GET', $this->config->getHost() . $resourcePath . ($query ? "?{$query}" : ''), $headers, $httpBody);
    }
    /**
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetBlockedDomains';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetBlockedDomains', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetEmailEventReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetEmailEventReport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function getEmailEventReportRequest($limit = '50', $offset = '0', $startDate = null, $endDate = null, $days = null, $email = null, $event = null, $tags = null, $messageId = null, $templateId = null, $sort = 'desc')
    {
        ...
        // query params
        if ($limit !== null) {
            $queryParams['limit'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($limit);
        }
        // query params
        if ($offset !== null) {
            $queryParams['offset'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($offset);
        }
        // query params
        if ($startDate !== null) {
            $queryParams['startDate'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($startDate);
        ...
        // query params
        if ($email !== null) {
            $queryParams['email'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($email);
        }
        // query params
        if ($event !== null) {
            $queryParams['event'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($event);
        }
        // query params
        if ($tags !== null) {
            $queryParams['tags'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($tags);
        }
        // query params
        if ($messageId !== null) {
            $queryParams['messageId'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($messageId);
        }
        // query params
        if ($templateId !== null) {
            $queryParams['templateId'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($templateId);
        }
        // query params
        if ($sort !== null) {
            $queryParams['sort'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($sort);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetReports';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetReports', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSmtpTemplateOverview';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSmtpTemplateOverview', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSmtpTemplates';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSmtpTemplates', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function getSmtpTemplatesRequest($templateStatus = null, $limit = '50', $offset = '0', $sort = 'desc')
    {
        ...
        if ($templateStatus !== null) {
            $queryParams['templateStatus'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($templateStatus);
        }
        // query params
        if ($limit !== null) {
            $queryParams['limit'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($limit);
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacBlockedContacts';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacBlockedContacts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function getTransacBlockedContactsRequest($startDate = null, $endDate = null, $limit = '50', $offset = '0', $senders = null, $sort = 'desc')
    {
        ...
        if (\is_array($senders)) {
            ...
            if ($senders !== null) {
                $queryParams['senders'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($senders);
            }
        }
        // query params
        if ($sort !== null) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacEmailContent';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacEmailContent', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    protected function getTransacEmailContentRequest($uuid)
    {
        ...
        // path params
        if ($uuid !== null) {
            $resourcePath = \str_replace('{' . 'uuid' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($uuid), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacEmailsList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacEmailsList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    public function sendTestTemplateWithHttpInfo($templateId, $sendTestEmail)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\PostSendFailed', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateSmtpEmail';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateSmtpEmail', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function smtpBlockedContactsEmailDeleteRequest($email)
    {
        ...
        // path params
        if ($email !== null) {
            $resourcePath = \str_replace('{' . 'email' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($email), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function smtpLogMessageIdDeleteRequest($messageId)
    {
        ...
        // path params
        if ($messageId !== null) {
            $resourcePath = \str_replace('{' . 'messageId' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($messageId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function updateSmtpTemplateRequest($templateId, $smtpTemplate)
    {
        ...
        $headers = \array_merge($defaultHeaders, $headerParams, $headers);
        $query = \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Query::build($queryParams);
        return new \EasyWPSMTP\Vendor\GuzzleHttp\Psr7\Request('PUT', $this->config->getHost() . $resourcePath . ($query ? "?{$query}" : ''), $headers, $httpBody);
    }
    /**
    ...
    protected function createHttpClientOption()
    {
        ...
        if ($this->config->getDebug()) {
            $options[\EasyWPSMTP\Vendor\GuzzleHttp\RequestOptions::DEBUG] = \fopen($this->config->getDebugFile(), 'a');
            if (!$options[\EasyWPSMTP\Vendor\GuzzleHttp\RequestOptions::DEBUG]) {
