...
class SendersApi
{
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateSenderModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateSenderModel', $e->getResponseHeaders());
    ...
    protected function deleteSenderRequest($senderId)
    {
        ...
        // path params
        if ($senderId !== null) {
            $resourcePath = \str_replace('{' . 'senderId' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($senderId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetIps';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetIps', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetIpsFromSender';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetIpsFromSender', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSendersList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSendersList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function getSendersRequest($ip = null, $domain = null)
    {
        ...
        // query params
        if ($ip !== null) {
            $queryParams['ip'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($ip);
        }
        // query params
        if ($domain !== null) {
            $queryParams['domain'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($domain);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
