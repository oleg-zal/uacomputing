...
class WebhooksApi
{
    ...
    protected function deleteWebhookRequest($webhookId)
    {
        ...
        // path params
        if ($webhookId !== null) {
            $resourcePath = \str_replace('{' . 'webhookId' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($webhookId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetWebhook';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetWebhook', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetWebhooks';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetWebhooks', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
