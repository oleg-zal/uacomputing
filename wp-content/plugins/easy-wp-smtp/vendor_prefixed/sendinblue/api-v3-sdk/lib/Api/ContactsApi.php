...
class ContactsApi
{
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\PostContactInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\PostContactInfo', $e->getResponseHeaders());
    ...
    protected function addContactToListRequest($listId, $contactEmails)
    {
        ...
        // path params
        if ($listId !== null) {
            $resourcePath = \str_replace('{' . 'listId' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($listId), $resourcePath);
        }
        // body params
        $_tempBody = null;
    ...
    protected function createAttributeRequest($attributeCategory, $attributeName, $createAttribute)
    {
        ...
        if ($attributeCategory !== null) {
            $resourcePath = \str_replace('{' . 'attributeCategory' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($attributeCategory), $resourcePath);
        }
        // path params
        if ($attributeName !== null) {
            $resourcePath = \str_replace('{' . 'attributeName' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($attributeName), $resourcePath);
        }
        // body params
        $_tempBody = null;
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateUpdateContactModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateUpdateContactModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 204:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateUpdateContactModel', $e->getResponseHeaders());
    ...
    protected function deleteContactRequest($identifier)
    {
        ...
        // path params
        if ($identifier !== null) {
            $resourcePath = \str_replace('{' . 'identifier' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($identifier), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteFolderRequest($folderId)
    {
        ...
        // path params
        if ($folderId !== null) {
            $resourcePath = \str_replace('{' . 'folderId' . '}', \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toPathValue($folderId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetAttributes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetAttributes', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetExtendedContactDetails';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetExtendedContactDetails', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetContactCampaignStats';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetContactCampaignStats', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetContacts';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetContacts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    protected function getContactsRequest($limit = '50', $offset = '0', $modifiedSince = null, $sort = 'desc')
    {
        ...
        if ($modifiedSince !== null) {
            $queryParams['modifiedSince'] = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::toQueryValue($modifiedSince);
        }
        // query params
        if ($sort !== null) {
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetFolder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetFolder', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetFolderLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetFolderLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetFolders';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetFolders', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetExtendedList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetExtendedList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreatedProcessId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreatedProcessId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = \EasyWPSMTP\Vendor\SendinBlue\Client\ObjectSerializer::deserialize($e->getResponseBody(), 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
