...
class Configuration
{
    ...
    public static function getDefaultConfiguration()
    {
        if (self::$defaultConfiguration === null) {
            self::$defaultConfiguration = new \EasyWPSMTP\Vendor\SendinBlue\Client\Configuration();
        }
     ...
     * @return void
     */
    public static function setDefaultConfiguration(\EasyWPSMTP\Vendor\SendinBlue\Client\Configuration $config)
    {
