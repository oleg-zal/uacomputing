 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetAttributesAttributes implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'category' => 'string', 'type' => 'string', 'enumeration' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetAttributesEnumeration[]', 'calculatedValue' => 'string'];
    /**
