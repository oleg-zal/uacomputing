 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetTransacBlockedContactsContacts implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'senderEmail' => 'string', 'reason' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetTransacBlockedContactsReason', 'blockedAt' => 'string'];
    /**
