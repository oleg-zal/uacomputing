 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateSmsCampaign implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'sender' => 'string', 'content' => 'string', 'recipients' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\CreateSmsCampaignRecipients', 'scheduledAt' => 'string'];
    /**
