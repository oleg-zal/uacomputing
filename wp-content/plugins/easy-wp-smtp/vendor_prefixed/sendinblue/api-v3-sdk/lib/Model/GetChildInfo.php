 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetChildInfo implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'firstName' => 'string', 'lastName' => 'string', 'companyName' => 'string', 'credits' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetChildInfoCredits', 'statistics' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetChildInfoStatistics', 'password' => 'string', 'ips' => 'string[]', 'apiKeys' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetChildInfoApiKeys'];
    /**
