 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetExtendedList implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'name' => 'string', 'totalBlacklisted' => 'int', 'totalSubscribers' => 'int', 'uniqueSubscribers' => 'int', 'folderId' => 'int', 'createdAt' => 'string', 'campaignStats' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetExtendedListCampaignStats[]', 'dynamicList' => 'bool'];
    /**
