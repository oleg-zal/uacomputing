 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AbTestCampaignResult implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['winningVersion' => 'string', 'winningCriteria' => 'string', 'winningSubjectLine' => 'string', 'openRate' => 'string', 'clickRate' => 'string', 'winningVersionRate' => 'string', 'statistics' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\AbTestCampaignResultStatistics', 'clickedLinks' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\AbTestCampaignResultClickedLinks'];
    /**
