 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateSmtpTemplate implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['tag' => 'string', 'sender' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\UpdateSmtpTemplateSender', 'templateName' => 'string', 'htmlContent' => 'string', 'htmlUrl' => 'string', 'subject' => 'string', 'replyTo' => 'string', 'toField' => 'string', 'attachmentUrl' => 'string', 'isActive' => 'bool'];
    /**
