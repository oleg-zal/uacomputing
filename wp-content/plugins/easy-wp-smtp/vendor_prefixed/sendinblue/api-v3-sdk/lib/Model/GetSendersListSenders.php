 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetSendersListSenders implements \EasyWPSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'name' => 'string', 'email' => 'string', 'active' => 'bool', 'ips' => 'EasyWPSMTP\\Vendor\\SendinBlue\\Client\\Model\\GetSendersListIps[]'];
    /**
